    ...
    return (
        ...
        >
            ...
            <input
             ...
             name={image.id} 
             id={image.id} 
             className={`absolute top-4 left-4 h-4 w-4 accent-blue-700 group-hover:opacity-100 transition-all delay-75 duration-200 ease-linear cursor-pointer ${selectThumbnails.find((photo) => photo.id === image.id) ? "opacity-100" : "opacity-0"}`}
